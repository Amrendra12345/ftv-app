...
const My_profile = () => {
  ...
  useEffect(() => {
    ...
    setFirst_name(
      JSON.parse(localStorage.getItem("loginDetails"))?.name_of_agency.split(
        " "
      )[0]
    );
    setLast_name(
    ...
    setPhone_number(
      JSON.parse(localStorage.getItem("loginDetails")).mobile_number || ""
    );
    ...
    setNationality(
      JSON.parse(localStorage.getItem("loginDetails")).country || ""
    );
    setCity(JSON.parse(localStorage.getItem("loginDetails")).city || "");
    setAddress(JSON.parse(localStorage.getItem("loginDetails")).address || "");
    setPassport_number(
      JSON.parse(localStorage.getItem("loginDetails")).passport_number || ""
    );
    setPassport_exp_date(
      JSON.parse(localStorage.getItem("loginDetails")).passport_exp_date || ""
    );
    setMarital_status(
      JSON.parse(localStorage.getItem("loginDetails")).marital_status || ""
    );
    setNumber_of_kids(
      JSON.parse(localStorage.getItem("loginDetails")).number_of_kids || ""
    );
  }, []);
  ...
  const updateProfile = () => {
    ...
    data.append(
      "user_id",
      JSON.parse(localStorage.getItem("loginDetails"))?.id
    );
    ...
    axios
      .post(`https://cms.fasttrackvisa.com/api/updateprofile`, data)
      .then((res) => {
        console.log(res);
      })
          ...
          <Row>
            ...
            <Col sm={12} md={9} lg={9}>
              <Row className="gutters5">
                ...
                <Col sm={6}>
                  <div className="ftv-field">
                    <label htmlFor="number_of_kids">
                      Number of Kids(0 to 3)
                    </label>
                    <select
                      className="form-control"
                      id="number_of_kids"
